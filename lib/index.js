...
export class Fs {
    ...
    static async pickMedia(args) {
        ...
        if (Fs.ios.Module) {
            ...
            return {
                url: res[0],
                mimeType: await this.getMimeType(res[0]) || '',
                release: () => {
                },
            };
        }
     ...
     */
    static async androidIsPackageInstalled(packageId) {
     ...
     */
    static async androidStartActivity(args) {
        if (Fs.android.Module) {
     ...
     */
    static async androidStartActivityForResult(args) {
        if (Fs.android.Module) {
